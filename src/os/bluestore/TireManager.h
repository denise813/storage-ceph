...
#ifndef CEPH_OS_BLUESTORE_TIREFREELISTMANAGER_H
#define CEPH_OS_BLUESTORE_TIREFREELISTMANAGER_H
...
class TireFreelistManager : FreelistManager {
public:
  CephContext* cct;
  BitmapFreelistManager * bfm;

public:
  TireFreelistManager(CephContext* cct) : cct(cct) {}
  ~TireFreelistManager() {}
