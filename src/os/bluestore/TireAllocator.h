 ...
 *
 */
#ifndef CEPH_OS_BLUESTORE_TIREALLOCATOR_H
#define CEPH_OS_BLUESTORE_TIREALLOCATOR_H
...
class TireAllocator :Allocator {
public:
  int64_t capacity,
  int64_t alloc_unit,
public:
  explicit TireAllocator(const std::string& name);
  ~TireAllocator() final;
